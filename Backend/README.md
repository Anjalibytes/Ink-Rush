# ⚙️ Backend Server Documentation - InkRush

This directory houses the WebSocket game server logic for InkRush. It is built using **Node.js**, **Express**, and **Socket.IO** using modern ES Modules.
